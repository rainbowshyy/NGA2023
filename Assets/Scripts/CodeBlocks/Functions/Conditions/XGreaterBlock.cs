...
{
    public XGreaterBlock(int[] param) : base(param) { conditionType = ConditionOptionType.Int; }
    ...
    {
        return "Runs this block's nested codeblocks if this unit's<color=#4eb2f3><b> X</b></color> position is greater than " + parameters[0] + ".";
    }
}