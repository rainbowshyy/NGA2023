...
{
    public EnemyRayWhileBlock(int[] param) : base(param) { conditionType = ConditionOptionType.Direction; }
    ...
    public override string ShowSyntax()
    {
        ...
        return "While Enemy at Raycast( <color=#4eb2f3>" + parameters[0] + "</color> , <color=#f38f4e>" + parameters[1] + "</color> )<sprite index=" + spriteIndex + ">";
    }
    ...
    public override string ToolTip()
    {
        ...
        return "Continuously runs this block's nested codeblocks while there is an enemy unit in the direction ( <color=#4eb2f3>" + parameters[0] + "</color> , <color=#f38f4e>" + parameters[1] + "</color> )<sprite index=" + spriteIndex + "> . A unit is an enemy if it is not on the same team as this unit.";
    }
}
